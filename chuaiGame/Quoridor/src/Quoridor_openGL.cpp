        ...
        {   // 客户端接收数据格式：
            ...
            {   // CP1M46
                ...
                else if ('M'==tmpC)
                {
                    ...
                    pThis->gameData[plX*2][plY*2]=GD_YELLOW;
                    pThis->plyer[color-1].x=plX;
                    pThis->plyer[color-1].y=plY;
                    //switch (color)
                    //{
                    //case GD_YELLOW:
                    //    gameData[plyer[0].x*2][plyer[0].y*2]=GD_BLANK;
                    //    gameData[plX*2][plY*2]=GD_YELLOW;
                    //    plyer[0].x=plX;
                    //    plyer[0].y=plY;
                    //    break;
                    //case GD_RED:
                    //    gameData[plyer[1].x*2][plyer[1].y*2]=GD_BLANK;
                    //    gameData[plX*2][plY*2]=GD_YELLOW;
                    //    plyer[1].x=plX;
                    //    plyer[1].y=plY;
                    //    break;
