...
player_p = pygame.image.load("res/pic/player.png")
home   = pygame.image.load("res/pic/home.png")
enemy = pygame.image.load("res/pic/enemy.png")

# 3 - Initialize the game
pygame.init()
screen=pygame.display.set_mode((ww, hh))
pygame.display.set_caption("window_frame -- by cgm")
